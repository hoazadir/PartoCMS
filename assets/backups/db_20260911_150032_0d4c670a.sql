...
INSERT INTO `backups` (`id`, `filename`, `filepath`, `type`, `size`, `tables_count`, `records_count`, `description`, `created_by`, `created_at`) VALUES ('1', 'full_20260911_150022_ed697202.zip', 'assets/backups/full_20260911_150022_ed697202.zip', 'full', '1558319', '25', '96', 'پشتیبان کامل', '1', '2026-09-11 18:30:22');
...
INSERT INTO `modules` (`id`, `slug`, `name`, `description`, `version`, `is_enabled`, `config`, `installed_at`) VALUES ('1', 'content', 'مدیریت محتوا', 'ایجاد و مدیریت مقالات، صفحات و محصولات', '1.0.0', '1', NULL, '2026-09-10 18:37:59');
...
INSERT INTO `rate_limits` (`id`, `ip_address`, `action`, `count`, `first_attempt`, `last_attempt`) VALUES ('1', '127.0.0.1', 'backup_create', '2', '2026-09-11 18:30:22', '2026-09-11 18:30:32');
